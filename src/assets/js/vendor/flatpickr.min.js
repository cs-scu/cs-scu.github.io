...
!(function (e, n) {
    ...
    var t = ["onChange", "onClose", "onDayCreate", "onDestroy", "onKeyDown", "onMonthChange", "onOpen", "onParseConfig", "onReady", "onValueUpdate", "onYearChange", "onPreCalendarPosition"],
        ...
        i = {
            ...
            isLeap: function (e, n) {
                return 1 === e && ((n % 4 == 0 && n % 100 != 0) || n % 400 == 0);
            },
            firstDayOfWeek: 0,
            ordinal: function (e) {
                var n = e % 100;
    ...
    var p = function () {},
        ...
        v = {
            ...
            U: function (e, n, t) {
                return new t.date(1e3 * parseFloat(n));
            },
            W: function (e, n, t) {
                var a = parseInt(n),
                    i = new t.date(e.getFullYear(), 0, 2 + 7 * (a - 1), 0, 0, 0, 0);
            ...
            u: function (e, n, t) {
                return new t.date(parseFloat(n));
            },
            w: p,
            y: function (e, n) {
            ...
            return function (e, n, i, o) {
                if (0 === e || e) {
                    var l,
                        c = o || r,
                        d = e;
                    if (e instanceof Date) l = new c.date(e.getTime());
                    else if ("string" != typeof e && void 0 !== e.toFixed) l = new c.date(e);
                    else if ("string" == typeof e) {
                        var s = n || (t || a).dateFormat,
                            u = String(e).trim();
                        if ("today" === u) (l = new c.date()), (i = !0);
                        else if (t && t.parseDate) l = t.parseDate(e, s);
                        else if (/Z$/.test(u) || /GMT$/.test(u)) l = new c.date(e);
                        else {
                            ...
                            (l = t && t.noCalendar ? new c.date(new c.date().setHours(0, 0, 0, 0)) : new c.date(new c.date().getFullYear(), 0, 1, 0, 0, 0, 0)),
    ...
    function k(p, v) {
        ...
        function _(e) {
            if (0 === w.selectedDates.length) {
                var n = void 0 === w.config.minDate || M(new w.l10n.date(), w.config.minDate) >= 0 ? new w.l10n.date() : new w.l10n.date(w.config.minDate.getTime()),
                    t = E(w.config);
            ...
            if (void 0 !== w.hourElement && void 0 !== w.minuteElement) {
                ...
                if (void 0 !== w.config.maxTime && void 0 !== w.config.minTime && w.config.minTime > w.config.maxTime) {
                    var c = y(w.config.minTime.getHours(), w.config.minTime.getMinutes(), w.config.minTime.getSeconds()),
                        d = y(w.config.maxTime.getHours(), w.config.maxTime.getMinutes(), w.config.maxTime.getSeconds()),
                        s = y(t, a, i);
                    if (s > d && s < c) {
                        var u = (function (e) {
                ...
                i
                    ? ((o.tabIndex = -1),
                      be(n) &&
                          ...
                          "range" === w.config.mode &&
                              (d(o, "startRange", w.selectedDates[0] && 0 === M(n, w.selectedDates[0], !0)), d(o, "endRange", w.selectedDates[1] && 0 === M(n, w.selectedDates[1], !0)), "nextMonthDay" === e && o.classList.add("inRange"))))
            ...
            void 0 === i
                ...
                ? (function (e, n) {
                      for (var t = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : w.currentMonth, a = n > 0 ? w.config.showMonths : -1, i = n > 0 ? 1 : -1, o = t - w.currentMonth; o != a; o += i)
                          for (var r = w.daysContainer.children[o], l = t - w.currentMonth === o ? e.$i + n : n < 0 ? r.children.length - 1 : 0, c = r.children.length, d = l; d >= 0 && d < c && d != (n > 0 ? c : -1); d += i) {
                              var s = r.children[d];
                              if (-1 === s.className.indexOf("hidden") && ne(s.dateObj) && Math.abs(e.$i - d) >= Math.abs(n)) return R(s);
                          }
        ...
        function K(e, n) {
            for (
                var t = (new w.l10n.date(e, n, 1).getDay() - w.l10n.firstDayOfWeek + 7) % 7,
                    a = new w.l10n.date(e, n, 0),
                    i = w.utils.getDaysInMonth(a.getMonth(), a.getFullYear()),
                    o = w.utils.getDaysInMonth(n, e),
                    r = window.document.createDocumentFragment(),
                    l = w.config.showMonths > 1,
                    c = l ? "prevMonthDay hidden" : "prevMonthDay",
                    d = l ? "nextMonthDay hidden" : "nextMonthDay",
                    u = i + 1 - t,
                    f = 0;
                u <= i;
                u++, f++
            )
                r.appendChild(W("flatpickr-day " + c, new w.l10n.date(a.getFullYear(), a.getMonth(), u), 0, f));
            for (u = 1; u <= o; u++, f++) r.appendChild(W("flatpickr-day", new w.l10n.date(e, n, u), 0, f));
            for (var m = o + 1; m <= 42 - t && (1 === w.config.showMonths || f % 7 != 0); m++, f++) r.appendChild(W("flatpickr-day " + d, new w.l10n.date(e, n + 1, m % o), 0, f));
            var g = s("div", "dayContainer");
        ...
        function U() {
            if (void 0 !== w.daysContainer) {
                ...
                for (var e = document.createDocumentFragment(), n = 0; n < w.config.showMonths; n++) {
                    var t = new w.l10n.date(w.currentYear, w.currentMonth, 1);
            ...
            if (!(w.config.showMonths > 1 || "dropdown" !== w.config.monthSelectorType)) {
                ...
                for (var n = 0; n < 12; n++)
                    if (e(n)) {
                        ...
                        (t.value = new w.l10n.date(w.currentYear, n).getMonth().toString()),
                ...
                switch (e.keyCode) {
                    ...
                    case 40:
                        ...
                        (w.daysContainer && void 0 !== n.$i) || n === w.input || n === w.altInput
                            ? e.ctrlKey
                                ? (e.stopPropagation(), ee(w.currentYear - d), J(B(1), 0))
                                : r || J(void 0, 7 * d)
                    ...
                    case 9:
                        if (r) {
                            var s = [w.hourElement, w.minuteElement, w.secondElement, w.amPM].concat(w.pluginElements).filter(function (e) {
                                    return e;
                                }),
                                u = s.indexOf(n);
                            if (-1 !== u) {
                                var f = s[u + (e.shiftKey ? -1 : 1)];
        ...
        function oe(e, n) {
            if ((void 0 === n && (n = "flatpickr-day"), 1 === w.selectedDates.length && (!e || (e.classList.contains(n) && !e.classList.contains("flatpickr-disabled"))))) {
                for (
                    ...
                    ne(new Date(d), !0) || ((r = r || (d > i && d < o)), d < a && (!l || d > l) ? (l = d) : d > a && (!c || d < c) && (c = d));
                Array.from(w.rContainer.querySelectorAll("*:nth-child(-n+" + w.config.showMonths + ") > ." + n)).forEach(function (n) {
                    ...
                    (r && !u) ||
                        ...
                        void 0 !== e &&
                            ...
                            a < t && s === a ? n.classList.add("startRange") : a > t && s === a && n.classList.add("endRange"),
                            s >= l && (0 === c || s <= c) && ((o = a), (d = t), (i = s) > Math.min(o, d) && i < Math.max(o, d)) && n.classList.add("inRange")));
                });
            }
        }
        function re() {
            !w.isOpen || w.config.static || w.config.inline || se();
        }
        function le(e) {
            return function (n) {
        ...
        function de() {
            ...
            var n = e(e({}, v), JSON.parse(JSON.stringify(p.dataset || {})));
            void 0 === n.getWeek && void 0 !== w.l10n.getWeek && (w.config.getWeek = w.l10n.getWeek),
                void 0 === n.time_24hr && void 0 === I.defaultConfig.time_24hr && (w.config.time_24hr = w.l10n.time_24hr),
                (w.formatDate = b(w)),
        ...
        function me(e) {
            ...
            if (void 0 !== n) {
                var t = n,
                    a = (w.latestSelectedDateObj = new w.l10n.date(t.dateObj.getTime())),
                ...
                if (
                    ...
                    U(),
                    ye(),
                    i || "range" === w.config.mode || 1 !== w.config.showMonths ? void 0 !== w.selectedDateElem && void 0 === w.hourElement && w.selectedDateElem && w.selectedDateElem.focus() : R(t),
        ...
        (w.parseDate = C({ config: w.config, l10n: w.l10n })),
            ...
            (w.open = function (e, n) {
                ...
                var a = w.isOpen;
                (w.isOpen = !0), a || (w.calendarContainer.classList.add("open"), w._input.classList.add("active"), De("onOpen"), se(n));
                ...
                (w.element = w.input = p),
                    ...
                    (function () {
                        ...
                        if (i.altInput && (i.enableTime || r) && !i.altFormat) {
                            var d = I.defaultConfig.altFormat || a.altFormat;
                    ...
                    (function () {
                        (w.selectedDates = []), (w.now = w.parseDate(w.config.now) || new w.l10n.date());
                        ...
                        (w._initialDate =
                            w.selectedDates.length > 0
                                ...
                                ? w.config.maxDate
                                : w.now),
                            (w._initialDate = new w.l10n.date(w._initialDate.getTime())),
                    ...
                    (w.utils = {
                        getDaysInMonth: function (e, n) {
                            return void 0 === e && (e = w.currentMonth), void 0 === n && (n = w.currentYear), w.l10n.daysInMonth[e] + (w.l10n.isLeap(e, n) ? 1 : 0);
                        },
                    }),
                    w.isMobile ||
                        (function () {
                            ...
                            w.config.enableTime &&
                                e.appendChild(
                                    (function () {
                                        ...
                                        var n = s("span", "flatpickr-time-separator", ":"),
                                        ...
                                        w.config.time_24hr ||
                                            ((w.amPM = s("span", "flatpickr-am-pm", w.l10n.amPM[r((w.latestSelectedDateObj ? w.hourElement.value : w.config.defaultHour) > 11)])),
