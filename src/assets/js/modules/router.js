            ...
            switch (block.type) {
                ...
                case 'video':
                    ...
                    if(hasYoutube) {
                        ...
                        if (youtubeIdMatch) {
                            tabsHTML += `<button class="platform-btn active" data-platform="youtube">یوتیوب</button>`;
                    ...
                    if(hasAparat) {
                        ...
                        if (aparatIdMatch) {
                            tabsHTML += `<button class="platform-btn ${!hasYoutube ? 'active' : ''}" data-platform="aparat">آپارات</button>`;
                    ...
                    if(tabsHTML) {
                        // <<-- ساختار جدید HTML برای پلیر ویدیو -->>
