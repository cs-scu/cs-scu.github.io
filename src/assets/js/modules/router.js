        ...
        blocks.forEach(block => {
            switch (block.type) {
                ...
                case 'video':
                    ...
                    if(tabsHTML) {
                        html += `<div class="video-container"><div class="video-player-area">${playersHTML}</div><div class="video-tabs-container"><div class="video-tabs">${tabsHTML}</div><div class="video-tab-highlighter"></div></div></div>`;
                    }
                    break;
