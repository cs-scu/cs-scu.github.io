...
export const showEventModal = async (path) => {
    ...
    if (contactBtn && !contactBtn.disabled) {
        contactBtn.addEventListener('click', (e) => {
            ...
            if (contactInfo.telegram) { contactItemsHTML += `<a href="${contactInfo.telegram}" target="_blank" rel="noopener noreferrer" class="contact-widget-item"><div class="contact-widget-icon telegram-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M9.78 18.46c.2.19.47.29.74.29.22 0 .44-.06.63-.18l1.93-1.22 3.92 2.88c.6.43 1.39.2 1.82-.4l3.14-14.71c.24-.95-.5-1.85-1.42-1.6l-15.68 5.7c-.91.33-1.22 1.4- .66 2.12l4.1 5.46 1.63-1.56z M11.13 15.9l-1.03 1.36-2.9-3.85 10.6-6.1-8.31 8.78z"></path></svg></div><div class="contact-widget-info"><strong>تلگرام</strong><span>ارسال پیام</span></div></a>`; }
            if (contactInfo.whatsapp) { contactItemsHTML += `<a href="${contactInfo.whatsapp}" target="_blank" rel="noopener noreferrer" class="contact-widget-item"><div class="contact-widget-icon whatsapp-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M16.6 14.2c-.2-.1-1.5- .7-1.7-.8-.2-.1-.4-.1-.6.1-.2.2-.6.7-.8.9-.1.1-.3.2-.5.1-.2-.1-1-.4-1.9-1.2-.7-.6-1.2-1.4-1.3-1.6s0-.4.1-.5c.1-.1.2-.2.4-.4.1-.1.2-.2.2-.4.1-.1.1-.4 0-.5C10.3 9.4 9 7.5 8.8 7c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3-.2.3-.9 1-.9 2.4s1 2.8 1.1 3c.1.2 2 3.2 4.9 4.3.7.3 1.2.4 1.6.4.6 0 1.1-.2 1.5-.9.4-.6.4-1.2.3-1.3c0-.1-.2-.2-.4-.3z m-4.7 6.4c-4.9 0-8.8-4-8.8-8.8S7 3 11.9 3s8.8 3.9 8.8 8.8-3.9 8.8-8.8 8.8z m5.3-14.5c-1.3-1.3-3.1-2.1-5.1-2.1-4.1 0-7.4 3.3-7.4 7.4s3.3 7.4 7.4 7.4 7.4-3.3 7.4-7.4c0-2- .8-3.8-2.3-5.2z"></path></svg></div><div class="contact-widget-info"><strong>واتساپ</strong><span>ارسال پیام</span></div></a>`; }
